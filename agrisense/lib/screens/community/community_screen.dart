  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(
          child: StreamBuilder<List<CommunityPostData>>(
            stream: provider.firestore.postsStream(),
...
class _PostCardState extends State<_PostCard> {
  ...
  void initState() {
    super.initState();
    _upvoteCount = widget.post.upvoteCount;
    _checkUpvoted();
  }

  Future<void> _checkUpvoted() async {
    final provider = context.read<AppProvider>();
    final result = await provider.firestore.hasUpvoted(widget.post.id);
    if (mounted) setState(() => _isUpvoted = result);
  }
  ...
  Future<void> _toggleUpvote() async {
    ...
    await provider.firestore.toggleUpvote(widget.post.id);
  }
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('${post.district} · ${post.timeAgo}', style: const TextStyle(fontSize: 11, color: AppColors.gray400)),
          ])),
          Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(provider.district, style: const TextStyle(fontSize: 11, color: AppColors.gray400)),
          ]),
        ]),
        ...
        ElevatedButton(
          onPressed: _isPosting ? null : () async {
            ...
            await provider.firestore.addPost(
              question: _questionCtrl.text.trim(),
              questionKin: _questionKinCtrl.text.trim(),
              cropTag: _selectedCrop.split(' ')[0],
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        if (posts.isEmpty)
          const Padding(
            ...
            child: Text('No posts found · Nta bibazo bibonetse', style: TextStyle(color: AppColors.gray400)),
          )
        else
          SizedBox(
            height: 300,
