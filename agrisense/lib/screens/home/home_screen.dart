      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('${post.district} · ${post.timeAgo}', style: const TextStyle(fontSize: 10, color: AppColors.gray400)),
          ])),
        ...
        Row(children: [
          ...
          const SizedBox(width: 4),
          Text('${post.replyCount} replies', style: const TextStyle(fontSize: 12, color: AppColors.gray400)),
        ]),
      ]),
    );
  }
