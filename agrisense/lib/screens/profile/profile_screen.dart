...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final phone = provider.phone.isNotEmpty
        ? provider.phone
        : provider.firebaseUser?.phoneNumber ?? '';
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        _SectionCard(
          ...
          child: crops.isEmpty
              ? const Text('No crops selected', style: TextStyle(color: AppColors.gray400))
              : Wrap(
        ...
        _SectionCard(
          ...
          child: Column(children: [
            ...
            ListTile(
              ...
              subtitle: Text(district, style: const TextStyle(fontSize: 11, color: AppColors.gray400)),
